...
namespace Salesync.Application.Modules.Inventory.Interfaces
{
    ...
    {
        Task<StockBalanceDto> CreateOpeningBalanceAsync(
        ...
        Task<StockBalanceDto> GetBalanceAsync(
            int productId,
            int warehouseId);

        Task<IEnumerable<StockBalanceDto>>
            GetAllBalancesAsync();

        Task<IEnumerable<StockMovementDto>>
            GetMovementsAsync(
                int? productId = null,
                int? warehouseId = null);

        Task<StockMovementDto> StockInAsync(
            int productId,
            int warehouseId,
            int quantity,
        ...
        Task<StockMovementDto> StockOutAsync(
            int productId,
            int warehouseId,
            int quantity,
            StockMovementSource source =
